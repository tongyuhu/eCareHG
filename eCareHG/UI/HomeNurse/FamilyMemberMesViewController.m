//
//  FamilyMemberMesViewController.m
//  eCareHG
//
...
{
    AddFamilyMemberMesVC *addVC =[[AddFamilyMemberMesVC alloc]init];
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    if (section ==2) {
        ...
        UILabel *lab =[[UILabel alloc]initWithFrame:CGRectMake(10, 7, 250, 18)];
        lab.textColor =TEXTGRAY;
        lab.font =[UIFont systemFontOfSize:11];
        lab.text =@"备注：最多可添加6位家庭成员";
        [view addSubview:lab];
        return view;
    }
    return nil;
